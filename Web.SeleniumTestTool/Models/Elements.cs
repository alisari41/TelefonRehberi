namespace Web.SeleniumTestTool.UserAndTelephone.Models
{
    public class Elements
    {
        ...
        public string IdPasswordError { get; set; }
        public string TxtGirisEmail { get; set; }
        public string TxtGirisPassword { get; set; }
        public string TxtMahalle { get; set; }
        public string TxtCadde { get; set; }
        public string TxtSokak { get; set; }
        public string TxtBinaNo { get; set; }
        public string TxtKat { get; set; }
        public string TxtIlce { get; set; }
        public string TxtIl { get; set; }
        ...
        public string BtnAdres { get; set; }
        public string BtnTelefonRehberi { get; set; }
